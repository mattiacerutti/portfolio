    ...
    <div className="flex flex-col gap-8">
      ...
      <VerticalReveal delay={baseDelay * 3}>
        <div className="flex flex-col gap-2">
          ...
          <P>
            The heavy lifting for parsing is done by <b>Tree-sitter</b>. It&apos;s what lets me extract functions and classes from source files, figure out which parts are strings
            or comments (so I know where not to trigger auto-closing brackets), and validate that a snippet is actually good enough to use.
          </P>
          <P>
      ...
      <VerticalReveal delay={baseDelay * 4}>
        <div className="flex flex-col gap-2">
          ...
          <P>
            This means snippets are <b>trackable</b> and <b>consistent</b>. If you get a snippet and share the link, someone else will get the exact same code. But it also means I
            have to deal with some interesting challenges.
          </P>
          ...
          <P>
            ...
            the same SHA as an existing one, I skip it. This keeps the <b>database</b> clean while still allowing new snippets to be added when meaningful changes happen.
          </P>
